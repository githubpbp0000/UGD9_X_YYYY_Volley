...
import com.example.ugd9_x_yyyy_volley.models.Produk;
...
public class AddEditActivity extends AppCompatActivity {
    ...
    private void getProdukById(long id) {
        ...
        final StringRequest stringRequest = new StringRequest(GET, ProdukApi.GET_BY_ID_URL + id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(AddEditActivity.this, produkResponse.getMessage(),
                                Toast.LENGTH_SHORT).show();
    ...
    private void createProduk() {
        ...
        final StringRequest stringRequest = new StringRequest(POST, ProdukApi.ADD_URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Gson gson = new Gson();
    ...
    private void updateProduk(long id) {
        ...
        final StringRequest stringRequest = new StringRequest(PUT, ProdukApi.UPDATE_URL + id,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Gson gson = new Gson();
